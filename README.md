...
<p>
The Lectionary's most current SD card file tree (in .zip format) can be found at https://drive.google.com/file/d/1hfidmVrpfyWPc9oo6UNs4nSP50uVIUuX/view?usp=sharing (Github lfs large file support is over quota and has been disabled, so the file will be hosted on a Google drive account for now).
</p>
<p>
