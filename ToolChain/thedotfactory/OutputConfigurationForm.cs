...
namespace TheDotFactory
{
    public partial class OutputConfigurationForm : Form
    {
        ...
        void loadOutputConfigurationToForm(OutputConfiguration outputConfig)
        {
            ...
            cbxOutputAscDescLineheight.Checked = outputConfig.outputAscDescLineheight;
            cbxOutputAdvanceHeight.Checked = outputConfig.outputAdvanceHeight;
            cbxOutputAdvanceWidth.Checked = outputConfig.outputAdvanceWidth;
        ...
        void loadFormToOutputConfiguration(ref OutputConfiguration outputConfig)
        {
            ...
            outputConfig.outputAscDescLineheight = cbxOutputAscDescLineheight.Checked;
            outputConfig.outputAdvanceHeight = cbxOutputAdvanceHeight.Checked;
            outputConfig.outputAdvanceWidth = cbxOutputAdvanceWidth.Checked;
        ...
        private void cbxOutputAdvanceHeight_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void cbxOutputAscDescLineheight_CheckedChanged(object sender, EventArgs e)
        {
